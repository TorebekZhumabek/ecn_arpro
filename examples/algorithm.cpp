...
int main()
{
    ...
    idx = find_if(vec.begin(), vec.end(),
                  [](int v) {return v%2 == 0;});
    Print("The first even number is at ", distance(vec.begin(), idx));
    cout << "The first even number is " << *idx << endl;
    ...
    idx = find_if(vec.begin(), vec.end(),
                  [](int v) {return v%2 == 1;});
    Print("The first odd number is at ", distance(vec.begin(), idx));
    cout << "The first odd number is " << *idx << endl;
    ...
    idx = find_if(vec.begin(), vec.end(),
                  [](int v) {return v%2 == 1;});
    Print("The first odd number is now at ", distance(vec.begin(), idx));
    cout << "The first odd number is " << *idx << endl;
    ...
    cout << endl << "Putting 4 smallest at the beginning (without sorting them)" << endl;
