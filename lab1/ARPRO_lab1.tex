...
The goal of the first C++ labs are to discover the language by building small projects.
...
\item Add this file in the CMakeLists.txt and right-click to run CMake to tell Qt Creator that the structure f the project has changed
